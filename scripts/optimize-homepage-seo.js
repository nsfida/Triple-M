...
function main() {
  ...
  // 1) Title + meta + social
  const title = "Triplem | Accounting &amp; Expense Tracking";
  const description =
    "Triplem is private accounting software for expense tracking, invoices, wallets, inventory, assets, and PDF reports—secure finance setup for owners. Start a free trial.";
  ...
  html = html.replace(
    ...
    `"name": "Triplem | Accounting & Expense Tracking"`
  );
  html = html.replace(
  ...
  html = html.replace(
    ...
    '<img src="Assets/logo/logo.png" alt="Triplem" width="28" height="28" loading="lazy" decoding="async" />'
  );
  html = html.replace(
    /alt="Logo"/g,
    'alt="Triplem logo"'
  ...
  html = html.replace(
    'alt="Triplem private finance solution sign-in emblem"',
    'alt="Triplem sign-in logo"'
  );
...
`;
  ...
  if (!html.includes("landing-footer-trust")) {
    html = html.replace(
      '<p class="landing-footer-copy">&copy; <span id="landingFooterYear"></span> Triplem · Money Management Module</p>',
      `<div class="landing-footer-trust">
            <p><strong>Triplem</strong> · Private accounting &amp; finance software · Founder: Nadeem Shahzad Fida</p>
            <p>
  ...
  html = html.replace(
    /<img src="Assets\/logo\/logo2\.png" alt="Triplem accounting solution and finance software logo" onerror="this\.src='Assets\/logo\/logo\.png'" \/>/,
    `<picture>
            <source type="image/webp" srcset="Assets/logo/logo2.webp" />
            <img src="Assets/logo/logo2.png" alt="Triplem accounting solution and finance software logo" width="148" height="42" decoding="async" fetchpriority="high" onerror="this.src='Assets/logo/logo.png'" />
          </picture>`
  );
