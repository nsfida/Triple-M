...
function main() {
  ...
  const description =
    "Manage income, expenses, wallets, loans, inventory, assets, invoices and reports in one private Triplem VIP finance workspace for individuals and businesses.";
