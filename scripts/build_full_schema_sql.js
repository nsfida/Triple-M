...
const CANONICAL_MIGRATION_FILES = [
  ...
  "093_security_hardening_session_login_rpc.sql",
  "094_expense_item_history_accuracy.sql",
  "095_expense_global_smart_search.sql",
  "096_free_signup_pro_payment_approvals.sql",
  "097_subscription_lifecycle_and_plan_portal.sql",
  "098_subscription_receipt_archive_and_details.sql",
  "099_live_chat_support_and_message_flexibility.sql",
  "100_live_chat_routing_agents_and_idle_followup.sql",
  ...
  "111_live_chat_ai_context_confidence_and_mobile_polish.sql",
  "112_live_chat_neural_semantic_ai.sql",
  "113_live_chat_ai_contextual_neural_agent_refinement.sql",
  "114_live_chat_guided_ai_agent_unlock.sql",
  "118_secure_web_push_notifications.sql",
  "119_web_push_delivery_reliability_and_messages.sql",
  "120_web_push_transport_and_notification_center_fix.sql",
  "123_push_consent_foreground_and_visitor_subscribers.sql",
  ...
  "134_aziz_gemini_live_support_toggle.sql",
  "135_aziz_authoritative_pricing_and_human_handoff.sql",
  "136_live_chat_agent_end_greeting_and_ui.sql",
  "137_aziz_verified_transcript_persistence.sql",
  "138_aziz_resilient_handoff_restore.sql",
  "139_aziz_canonical_conversation_handoff.sql",
  ...
  "149_full_accounting_erp_core.sql",
  "150_accounting_backup_restore_integrity.sql",
  ...
  "157_financial_audit_section_summary.sql",
  ...
  "170_insurance_module.sql",
  "171_insurance_admin_access_fix.sql",
...
drop table if exists public.app_push_live_chat_dispatches cascade;
drop table if exists public.app_push_subscriptions cascade;
