/* Triplem VIP Web Push Service Worker — v123; static asset cache hardening v175-insurancecancellation1. */
"use strict";

const STATIC_CACHE_PREFIX = "triplem-static-";
const STATIC_CACHE = `${STATIC_CACHE_PREFIX}v175-insurancecancellation1`;
