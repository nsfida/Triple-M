...
/** Demo mode intentionally excludes production SQL/schema assets. */
async function downloadAdminBackupSql(){
  const message = "SQL/schema export is unavailable in the interactive Demo. No production database files are bundled here.";
  setAdminBackupStatus(message, "ok");
