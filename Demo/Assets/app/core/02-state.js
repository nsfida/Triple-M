...
const state = {
  ...
  modalInstallmentType: "bought",
  installmentPlanView: "bought",
  editId: null,
  editKind: null,
  expenseWalletFilter: "all",
  expenseRecordView: "history",
  expenseDateFrom: "",
  expenseDateTo: "",
  ...
  expenseLazy: {
    ...
    detailCache: new Map(),
    itemHistoryRpcAvailable: null,
    itemServerPaging: null,
    itemSummaryQueryKey: "",
    itemSummaries: [],
  ...
  assets: [],
  assetTransactions: [],
  assetTransactionLoadedIds: new Set(),
  assetTransactionOffsets: {},
  assetTransactionHasMore: {},
  assetTransactionPageSize: 250,
  assetsLoaded: false,
  assetsLoading: false,
  bitcoinWallets: [],
