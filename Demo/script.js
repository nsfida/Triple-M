...
async function runDashboard(token) {
  await cue("One glance across the books", "Triplem combines live financial summaries without leaving the dashboard.", 8, token);
