...
function openCompanyTeamMemberPermissionsEditor(card, member){
  ...
  const storedPw = member.admin_visible_password || "";
    ...
    <div class="company-team-edit-grid">
      ...
      <div class="form-group" style="grid-column:1/-1">
        ...
        <div class="admin-password-row">
          <input class="input" data-team-edit="password" type="password" autocomplete="new-password" value="" data-original="${escapeHtml(storedPw)}" placeholder="${storedPw ? "••••••••  (leave blank to keep)" : "Enter a new password"}" />
        ...
        <p class="help tiny">Company accounts can view and change team member passwords. Leave blank to keep the current password.</p>
      </div>
      <div class="form-group" style="grid-column:1/-1">
