  ...
  modal.innerHTML = `
    ...
    <div class="modal-dialog trial-signup-dialog signup-v2-dialog" role="dialog" aria-modal="true" aria-labelledby="trialSignupTitle">
      <div class="modal-head trial-signup-head signup-v2-head">
        <div>
          <p class="trial-signup-kicker"><i class="fa-solid fa-user-plus" aria-hidden="true"></i> Free Sign-up</p>
          <h3 id="trialSignupTitle">Create your Triplem VIP workspace</h3>
          <p>Choose your plan and account type. Your workspace opens immediately.</p>
        </div>
      ...
      <div class="modal-body trial-signup-body signup-v2-body">
        <section class="signup-v2-step" data-signup-step="1">
          <div class="signup-plan-grid">
            <button type="button" class="signup-plan-card ${stateSignup.plan === "free" ? "selected" : ""}" data-signup-plan="free">
              <span class="signup-plan-icon"><i class="fa-solid fa-gift"></i></span><strong>Free 14 Days</strong>
              <b>No payment</b><small>Full workspace trial · no card required</small>
            </button>
            <button type="button" class="signup-plan-card ${stateSignup.plan === "monthly" ? "selected" : ""}" data-signup-plan="monthly">
              <span class="signup-plan-icon"><i class="fa-solid fa-calendar"></i></span><strong>Pro Monthly</strong>
              <div class="signup-price-lines">${priceLines("monthly")}</div>
              <small>Limited offer: Pro Month + 30 Days Free</small>
            </button>
            <button type="button" class="signup-plan-card ${stateSignup.plan === "yearly" ? "selected" : ""}" data-signup-plan="yearly">
              ...
              <small>Limited offer: Pro Year + 60 Days Free</small>
            </button>
          </div>
        </section>
