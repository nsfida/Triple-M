      ...
      <details class="loan expense-item-row" data-expense-details-id="history-${escapeHtml(item.key)}" data-expense-item-key="${escapeHtml(item.key)}" data-expense-item-complete="${item.detailComplete === false ? "0" : "1"}">
        <summary>
          <div class="loan-top">
            ...
            <div class="lt-action">
              <button type="button" class="icon-btn ghost expenseItemPdfBtn" data-item-key="${escapeHtml(item.key)}" title="Download PDF" style="font-size: 0.9rem;"><i class="fa-solid fa-download"></i></button>
            </div>
          </div>
        </summary>
        <div class="detail">
