...
(function (global) {
  ...
  function currencyOptions(selected = baseCurrency()) {
    const codes = global.TriplemCurrencyRegistry?.codes?.() || [];
  ...
  global.TriplemAccounting = {
    state: stateA,
    load: loadAccountingWorkspace,
    render: renderAccountingView,
    openDocument: openDocumentModal,
    openJournal: openJournalModal,
    viewDocument: openDocumentView,
    viewJournal: openJournalView
  };
