...
function sectionDetailsThemeColors(){
  ...
  const useThemeTokens = activeTheme !== "default";
  // Chart accent set: blue / sky / pink / red / black
  const blue = useThemeTokens ? read("--primary", "#2563eb") : "#2563eb";
  const sky = useThemeTokens ? read("--success", "#0ea5e9") : "#0ea5e9";
  const pink = useThemeTokens ? read("--warning", "#ec4899") : "#ec4899";
  const red = useThemeTokens ? read("--danger", "#e11d48") : "#e11d48";
  ...
  return {
    ...
    red,
    black,
    primarySoft: useThemeTokens ? read("--primary-soft", "rgba(37,99,235,.12)") : "rgba(37,99,235,.12)",
    success: sky,
    warning: pink,
    danger: red,
    muted: useThemeTokens ? read("--muted", "#94a3b8") : (isDark ? "#94a3b8" : "#64748b"),
    text: useThemeTokens ? read("--text", black) : black,
    line: read("--line", "rgba(208,213,221,.70)"),
    bg,
    panel: useThemeTokens ? read("--surface", "rgba(22,28,36,.92)") : (isDark ? "rgba(22,28,36,.92)" : "#ffffff"),
