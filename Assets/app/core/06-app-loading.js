...
function appDataLoadingMessageForTab(tab){
  ...
  return { title: "Your data is loading…", sub: "Please wait a moment" };
}
...
function ensureAppDataLoadingOverlay(){
  ...
  el.innerHTML = `
    <div class="app-data-loading-card">
      <div class="app-data-loading-spinner" aria-hidden="true">
        <span></span><span></span><span></span>
      </div>
      <p class="app-data-loading-title" id="appDataLoadingTitle">Your data is loading…</p>
      <p class="app-data-loading-sub" id="appDataLoadingSub">Please wait a moment</p>
    </div>`;
