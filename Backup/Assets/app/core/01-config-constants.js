...
function getEmbeddedSupabaseConfig(){
  ...
  // "https://aeyzorrqucqawbvnfpgc.supabase.co" XOR 41
  const urlParts = [
  ...
  const host = ["aeyzo","rrqucq","awbvnf","pgc"].join("");
  const supabaseUrl = ["https://", host, ".supabase.co"].join("");
  const keyParts = [
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9",
    "eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFleXpvcnJxdWNxYXdidm5mcGdjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc0NTk1NzQsImV4cCI6MjA5MzAzNTU3NH0",
    "WhZwc3Z2mgFUAXqWhKXPKHZBHVgbhKrNdpy7tIumcIM"
  ];
